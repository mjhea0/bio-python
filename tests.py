...
class Problem1TestCase(unittest.TestCase):
    ...
    def test_parseFastqSeq(self):
        ...
        self.assertEqual(parseFastqSeq(['./mocks/mock-test1.fastq']), 0.42857142857142855)
...
class Problem2TestCase(unittest.TestCase):
    ...
    def test_find_most_common_sequences(self):
    	...
    	self.assertEqual(freqFastaSeq('./mocks/mock-test2.fasta'), [('AAA', 8), ('BBB', 3), ('NNN', 1), ('VVV', 1), ('TRTR', 1), ('123', 1), ('111', 1), ('RTR', 1), ('FFF', 1), ('CCC', 1)])
...
#         self.assertEqual(parseTSVforChromes('./mocks/mock-test3.tsv'), [['chr12', '20704380'], ['chr12', '20704379'], ['chr21', '9827238'], ['chr5', '71146882'], ['chr8', '38283717'], ['chr12', '20704371'], ['chr12', '20704377'], ['chr21', '9827364'], ['chr4', '184083607'], ['chr11', '85195011'], ['chr11', '85195078'], ['chr12', '20704387'], ['chr21', '9827418'], ['chr12', '20704369'], ['chr12', '20704360'], ['chr2', '133012823']])
...
#         self.assertEqual(parseGTF("./mocks/mock-test3.gtf",array1, array2), [['chr12', '20704380'], ['chr12', '20704379'], ['chr12', '20704387']])
